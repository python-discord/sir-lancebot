    ...
    async def about_command(self, ctx: Context) -> None:
        ...
        embed = Embed(
            ...
            description=(
                ...
                f"walked away as grand champions. Make sure you check out `{ctx.prefix}snakes sal`, `{ctx.prefix}snakes draw` "
                f"and `{ctx.prefix}snakes hatch` to see what they came up with."
            )
        )
