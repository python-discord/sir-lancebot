...
class Traditions(commands.Cog):
    """A cog which allows users to get a random easter tradition or
       custom from a random country."""
    ...
    async def easter_tradition(self, ctx):
        ...
        traditions = {'England': 'Easter in England is celebrated through the exchange of Easter Eggs and other gifts like clothes, chocolates or holidays packages. Easter bonnets or baskets are also made that have fillings like daffodils in them.',
                      ...
                      'Poland': 'They shape the Easter Butter Lamg (Baranek Wielkanocyny) from a chunk of butter. They attempt to make it look like a fluffy sheep!',
                      'Greece': 'They burn an effigy of Judas Iscariot, they betrayer of Jesus, sometimes is done as part of a Passion Play! It is hung by the neck and then burnt.',
